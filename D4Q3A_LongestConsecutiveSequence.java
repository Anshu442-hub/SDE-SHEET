...
public class D4Q3A_LongestConsecutiveSequence {
    ...
    public static void main(String[] args) {
        ...
        int nums3[]={};//0
        int nums4[]={1,3,1,2,0,7,9};//4

        System.out.println(sequence.longestConsecutive(nums1));
        System.out.println(sequence.longestConsecutive(nums2));
        System.out.println(sequence.longestConsecutive(nums3));
        System.out.println(sequence.longestConsecutive(nums4));
    }
